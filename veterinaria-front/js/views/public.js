...
function getLocalPromos() {
    return [
        { id: 1, title: 'Desparasitación completa', desc: '10% dcto. en combo antiparasitario + antipulgas.', price: 19990, image: '/assets/promo-antiparasitario.jpg', badge: '¡Nuevo!' },
        { id: 2, title: 'Vacunación canina', desc: 'Plan anual a precio preferente.', price: 24990, image: '/assets/promo-vacuna.jpg', badge: 'Temporada' },
        { id: 3, title: 'Profilaxis dental', desc: 'Incluye evaluación y recomendaciones.', price: 34990, image: '/assets/promo-profilaxis.jpg', badge: 'Top' }
    ];
}
