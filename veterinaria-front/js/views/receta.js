export async function init({ root, API }) {
    ...
    <div class="toolbar">
      ...
      <button id="btnReload" class="btn btn-outline">Recargar</button>
    </div>
  ...
  `;
    ...
    // ---- Auth helpers (tolerante a tu esquema)
    ...
    function getUserName() {
        const u = getUser() || {};
        return u.nombre || u.fullName || u.displayName || u.name || '';
    }
    ...
    async function loadMascotas() {
        ...
        $selMascota.innerHTML = `<option value="" disabled selected>Selecciona…</option>` +
